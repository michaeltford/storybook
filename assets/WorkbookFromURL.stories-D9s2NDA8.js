import{j as o}from"./index-DnbSW_dr.js";import{r as s}from"./iframe-CFX7S7Ts.js";import{U as b,z as w}from"./index-B7DS8934.js";import{B as u}from"./TextField-Cy8kN4Kh.js";import"./index-CrMj5-ZH.js";import"./QkxRNX4E_VTO1B3P-DKjXYKjB.js";import"./client-BUjZUdG5.js";import"./Tooltip-BRziopUZ.js";const y=c=>{const{...p}=c,k={source:null},[t,h]=s.useState("https://www.sheetxl.com/examples/features-checklist.xlsx"),[l,m]=s.useState(null),[f,d]=s.useState(""),x=async i=>{const n=await fetch(t);if(!n.ok)throw`Unable to fetch: ${n.url}`;const r=await w.read({...k,source:{input:t},formatType:"xlsx"});return d(r.title),m(r.workbook),r.workbook},a={border:"blue solid 2px",borderRadius:"8px",flex:"1 1 100%"};return o.jsx(u,{sx:{minHeight:"560px",display:"flex",position:"relative"},children:l?o.jsx(o.Fragment,{children:o.jsx(b,{sx:{...a,position:"absolute"},...p,workbook:l,title:f})}):o.jsxs(u,{style:{padding:"8px 16px",display:"flex",flexDirection:"row",gap:"8px",alignItems:"start",...a},children:[o.jsx("input",{style:{minWidth:"360px"},name:"input-url",autoComplete:"off",value:t,onChange:i=>{h(i.target.value)}}),o.jsx("button",{onClick:x,children:"Fetch"})]})})},e=y.bind({});e.args={};e.storyName="From URL";const B={title:"Models/From URL",component:e};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`props => {
  const {
    ...rest
  } = props as any;
