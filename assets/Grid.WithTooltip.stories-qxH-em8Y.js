import{j as c}from"./index-Xhm29a53.js";import{r as p,m as u}from"./iframe-CaYotimM.js";import{w as T,t as I}from"./index-BXTp2-po.js";import"./RelaxedChangeTextField-rK-_vBVC.js";import{s as b}from"./SimpleCellRenderer-DJleXhQn.js";import{T as O}from"./Tooltip-hzUfLgYU.js";import"./index-cworlLnn.js";import"./preload-helper-D9Z9MdNV.js";import"./index-awv0QDyE.js";import"./client-CzTnkZmB.js";import"./index-D6FgJs_E.js";import"./TextField-Dthb3Mti.js";const E=h=>{const{...m}=h,l=p.useRef(null),[w,g]=p.useState(null),[x,R]=p.useState(),n=u.useRef({x:0,y:0,width:0,height:0}),a=u.useRef(null),y=e=>{const r=l.current.getViewFromClient(e.clientX,e.clientY);if(!r)return;const o=r.getCellCoordsFromClient(e.clientX,e.clientY),i=r.getRelativePointFromClient(0,0),s=r.getLayout(),d=s.getColOffset(o.colIndex)-i.x,f=s.getRowOffset(o.rowIndex)-i.y,P=s.getColOffset(o.colIndex+1)-i.x,S=s.getRowOffset(o.rowIndex+1)-i.y;n.current={x:d,y:f,width:P-d,height:S-f},R(`This is a hover text for (${o.rowIndex}, ${o.colIndex})`),a.current!==null&&a.current.update()},{overlay:v,...C}=T({gridRef:l,selection:w,onSelectionChange:e=>g(e)});return c.jsx(O,{arrow:!0,title:c.jsxs("a",{href:"https://www.sheetxl.com",children:["Hover over ",x]}),placement:"right",PopperProps:{popperRef:a,anchorEl:{getBoundingClientRect:()=>new DOMRect(n.current.x,n.current.y,n.current.width,n.current.height)},modifiers:[{name:"offset",options:{offset:[0,10]}}]},children:c.jsx("div",{className:"storybook-container",children:c.jsx(I,{...m,ref:l,cellRenderer:b,onPointerDown:e=>{C.onPointerDown(e)},onPointerMove:y,overlays:[v]})})})},t=E.bind({});t.args={columnCount:200,rowCount:200};t.storyName="with Tooltip";const N={title:"Grid",component:t,parameters:{controls:{sort:"requiredFirst"}}};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`props => {
  const {
    ...rest
  } = props as any;
